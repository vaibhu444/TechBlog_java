    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="Login.jsp"><span class="fa fa-user-circle-o"></span>Log In</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="Registration.jsp"><span class="fa fa-user-plus"></span>Registration</a>
                </li>
